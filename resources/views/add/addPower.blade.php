@extends('layout')
@section('name')
    Додати інформацію про портативну батарею
@endsection
@section('content')
    <div class="container">
        @if($errors->any())
        ...
        @endif
        <form method="post" action="{{route('addPowerSubmit')}}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" name="energy" placeholder="" required>
            </div>
            <div class="form-group">
